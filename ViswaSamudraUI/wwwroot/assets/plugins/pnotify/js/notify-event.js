        ...
        var notice = new PNotify({
            ...
            confirm: {
                ...
                buttons: [
                    {
                        text: 'Yes',
                        addClass: 'btn waves-effect waves-light btn-sm btn-primary'
                    },
                    {
                        addClass: 'btn waves-effect waves-light btn-sm btn-link'
                    }
                ]
            },
            buttons: {
        ...
        new PNotify({
            ...
            confirm: {
                ...
                buttons: [
                    {
                        text: 'Fries',
                        addClass: 'btn waves-effect waves-light btn-sm bg-blue',
                    ...
                    },
                    {
                        ...
                        addClass: 'btn waves-effect waves-light btn-sm bg-pink-400',
                        click: function(notice) {
                            notice.update({
                                title: 'You\'ve chosen a side',
                    ...
                    {
                        text: 'Fruit',
                        addClass: 'btn waves-effect waves-light btn-sm bg-indigo-400',
                        click: function(notice) {
                            notice.update({
                                title: 'You\'ve chosen a side',
                                text: 'You want fruit.',
