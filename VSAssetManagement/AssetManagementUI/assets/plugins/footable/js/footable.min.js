    ...
    b.Filtering = b.Component.extend({
        ...
        $create: function() {
            var c, d = this,
                ...
                h = a("<button/>", {
                    type: "button",
                    "class": "btn waves-effect waves-light btn-default dropdown-toggle"
                }).on("click", {
                    self: d
...
function(a, b) {
    b.Editing = b.Component.extend({
        ...
        $buttonShow: function() {
            return '<button type="button" class="btn waves-effect waves-light btn-primary footable-show">' + this.showText + "</button>"
        },
        $buttonHide: function() {
            return '<button type="button" class="btn waves-effect waves-light btn-default footable-hide">' + this.hideText + "</button>"
        },
        $buttonAdd: function() {
            return '<button type="button" class="btn waves-effect waves-light btn-primary footable-add">' + this.addText + "</button> "
        },
        $buttonEdit: function() {
            return '<button type="button" class="btn waves-effect waves-light btn-default footable-edit">' + this.editText + "</button> "
        },
        $buttonDelete: function() {
            return '<button type="button" class="btn waves-effect waves-light btn-default footable-delete">' + this.deleteText + "</button>"
        },
        $buttonView: function() {
            return '<button type="button" class="btn waves-effect waves-light btn-default footable-view">' + this.viewText + "</button> "
        },
        $rowButtons: function() {
