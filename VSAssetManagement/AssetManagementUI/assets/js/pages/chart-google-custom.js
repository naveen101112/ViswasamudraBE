    ...
    setTimeout(function() {
        ...
        function drawVisualization() {
            ...
            var options = {
                ...
                colors: ['#4680ff', '#7759de', '#ff5252', '#ffa21d', '#11c15b','#00ACC1']
            };
        ...
        function drawChartDonut() {
            ...
            var optionsDonut = {
                ...
                pieHole: 0.4,
                colors: ['#4680ff', '#7759de', '#ff5252', '#ffa21d', '#11c15b']
            };
        ...
        function drawChartThreshold() {
            ...
            var optionsThreshold = {
                ...
                colors: ['#4680ff', '#7759de', '#ffa21d', '#11c15b']
            };
