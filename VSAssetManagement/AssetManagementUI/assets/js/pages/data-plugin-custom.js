$(document).ready(function() {
    setTimeout(function() {
        ...
        $('<button class="btn waves-effect waves-light btn-primary m-b-20">sum of age in all rows</button>')
            .prependTo('.dt-plugin-buttons')
            .on('click', function() {
                alert('Column sum is: ' + table.column(3).data().sum());
            });

        $('<button class="btn waves-effect waves-light btn-primary m-r-10 m-b-20">sum of age of visible rows</button>')
            .prependTo('.dt-plugin-buttons')
            .on('click', function() {
