USE [master]
GO
/****** Object:  Database [VISWASAMUDRA]    Script Date: 11-10-2022 00:28:33 ******/
CREATE DATABASE [VISWASAMUDRA]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'VISWASAMUDRA', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\VISWASAMUDRA.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'VISWASAMUDRA_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\VISWASAMUDRA_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [VISWASAMUDRA] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [VISWASAMUDRA].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [VISWASAMUDRA] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET ARITHABORT OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [VISWASAMUDRA] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [VISWASAMUDRA] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET  DISABLE_BROKER 
GO
ALTER DATABASE [VISWASAMUDRA] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [VISWASAMUDRA] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [VISWASAMUDRA] SET  MULTI_USER 
GO
ALTER DATABASE [VISWASAMUDRA] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [VISWASAMUDRA] SET DB_CHAINING OFF 
GO
ALTER DATABASE [VISWASAMUDRA] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [VISWASAMUDRA] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [VISWASAMUDRA] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [VISWASAMUDRA] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [VISWASAMUDRA] SET QUERY_STORE = OFF
GO
USE [VISWASAMUDRA]
GO
/****** Object:  Table [dbo].[ASSET]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ASSET_HISTORY]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ASSET_OPERATIONS]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[BATCH]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PROJECT]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PURCHASE_ORDER]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[STATUS]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[STORE]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TAG]    Script Date: 11-10-2022 00:28:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [VISWASAMUDRA] SET  READ_WRITE 
GO
